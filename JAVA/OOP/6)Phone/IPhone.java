public class IPhone extends Phone implements Ringable {                         // creates a class named, 'IPhone' that extends 'Phone' and implements 'Ringable'
    public IPhone(String versionNumber, int batteryPercentage, String carrier, String ringTone) {   // creates a constructor for the 'IPhone' class
